...
export class GlavnaKnjigaComponent implements OnInit {
  ...
  racunanjeAktiveiPasive(brA1, brA2, brA3, brA4, brA5, brA6, brA7, brA8, brA9, brA10, brP1, brP2, brP3, brP4, brP5, brP6, brP7, brP8, brP9, brP10) {
    let rezultatAktiva = this.funkcijeSabloni.getElement('rezultatAktiva'),
      rezultatPasiva = this.funkcijeSabloni.getElement('rezultatPasiva'),
  ...
  sacuvajGlavnuKnjigu(event, bsp, brA1, brA2, brA3, brA4, brA5, brA6, brA7, brA8, brA9, brA10, brP1, brP2, brP3, brP4, brP5, brP6, brP7, brP8, brP9, brP10, textA1, textA2, textA3, textA4, textA5, textA6, textA7, textA8, textA9, textA10, textP1, textP2, textP3, textP4, textP5, textP6, textP7, textP8, textP9, textP10) {
  ...
  prikazSacuvanihBilansaStanja() {
    ...
    return this.sacuvaniBilans = nizBilansaStanja
  }
  prikazSacuvaniBilansaStanja(){
    let nizBilansaStanja = Object.keys(this.sacuvaniBilansi);
    this.sacuvaniBilans=nizBilansaStanja;
  }

  izbrisiBilansStanja(event) {
    if (this.funkcijeSabloni.potvrda() === false) {
      return;
    } else {
      delete this.sacuvaniBilansi[event.target.id];
      alert('Uspesno obirsan bilas stanja za dati datum !');
